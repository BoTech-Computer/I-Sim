...
namespace CPU_Sim.SchematicEditor.Model
{
    public class Item
    {
        ...
        public System.Windows.Media.Color  fillColor = System.Windows.Media.Colors.LightGray;
        public System.Windows.Media.Color lineColor = System.Windows.Media.Colors.Black;

        public Item(string ID, string Name, string Caption, System.Windows.Media.Color fillColor, System.Windows.Media.Color lineColor, bool Visible = true, bool Selected = false, Point position = default)
        {
            this.Name = Name;
